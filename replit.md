...
Chat header design preference: No emojis in main conversation titles (project/team/agent names), but keep team and agent icons when showing participants under each section - keep main titles clean with text-only.
